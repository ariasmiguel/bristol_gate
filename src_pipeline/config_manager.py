...
class ConfigurationManager:
    ...
    def get_data_directories(self) -> Dict[str, str]:
        ...
        directories = {
            'base': base_data_dir,
            'bronze': os.getenv('BRONZE_DATA_DIR', f'{base_data_dir}/bronze'),
            'silver': os.getenv('SILVER_DATA_DIR', f'{base_data_dir}/silver'),
            'gold': os.getenv('GOLD_DATA_DIR', f'{base_data_dir}/gold'),
